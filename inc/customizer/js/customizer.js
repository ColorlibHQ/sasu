(function( $ , api){
    ...
    api.section( 'sasu_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'sasu_about_section' , function( section ){
    ...
    api.section( 'sasu_blog_section' , function( section ){
    ...
    api.section( 'sasu_portfolio_section' , function( section ){
    ...
    api.section( 'sasu_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-sasu_contact_custom_formshortcode'),
                selector = $('#_customize-input-sasu_contact_formshortcode');
    ...
    // General section
    api.section( 'sasu_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#sasu_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-sasu_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-sasu_preloader_color' );
            ...
            var $backtotop          = $( '#sasu_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-sasu_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-sasu_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'sasu_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#sasu_footer_widget_toggle');
