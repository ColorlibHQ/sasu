...
/**
 *
 * Sasu elementor cta part section widget.
 *
 * @since 1.0
 */
class Sasu_Cta_Part extends Widget_Base {

	public function get_name() {
		return 'sasu-cta-part';
	}

	public function get_title() {
		return __( 'Cta Part', 'sasu' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'cta_part_section',
            [
                'label' => __( 'Cta Part Content', 'sasu' ),
            ]
        );
        $this->add_control(
            'cta_part_content',
            [
                'label'         => esc_html__( 'Cta Part Header', 'sasu' ),
                'type'          => Controls_Manager::WYSIWYG,
                'default'       => __( '<h2>Very useful Friendly</h2><p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum suspendisse ultrices gravida. Risus commodo</p>', 'sasu' )
            ]
        );
        $this->add_control(
            'cta_part_btnlabel1',
