...
----------------------------------------*/
class sasu_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('sasu_instagram_photo',esc_html__('[ Sasu ] Intagram Photo','sasu'),array(
			'description' => esc_html__('Sasu Instagram Photo Widget','sasu'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'sasu');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'sasu'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'sasu'); ?></label>
...
if(!function_exists('sasu_instagram_widgets')):
	function sasu_instagram_widgets(){
		register_widget('sasu_instagram_photo');
	}
	add_action('widgets_init','sasu_instagram_widgets');
endif;
