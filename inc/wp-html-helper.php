...
// image default alt
if( !function_exists( 'sasu_img_default_alt' ) ){
	function sasu_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'sasu_img_tag' ) ){
	function sasu_img_tag( array $args ){
...
// Anchor Tag
if( !function_exists( 'sasu_anchor_tag' ) ){
	function sasu_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'sasu_heading_tag' ) ){
	function sasu_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'sasu_paragraph_tag' ) ){
	function sasu_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'sasu_other_tag' ) ){
	function sasu_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'sasu_button_element ' ) ){
	function sasu_button_element( array $args ){
