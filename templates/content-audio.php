...
?>
	...
	<article id="post_<?php the_ID(); ?>" <?php post_class('masonry__brick entry format-audio'); ?> data-aos="fade-up">
		...
		/**
		 * Blog Post Meta
		 * @Hook  sasu_blog_posts_meta
		 *
		 * @Hooked sasu_blog_posts_meta_cb
		 * 
		 *
		 */
		do_action( 'sasu_blog_posts_meta' );
		 ...
		 * @Hook  sasu_blog_posts_excerpt
		 *
		 * @Hooked sasu_blog_posts_excerpt_cb
		 * 
		 *
		 */
		do_action( 'sasu_blog_posts_excerpt' );
